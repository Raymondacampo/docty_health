...
SESSION_COOKIE_SAMESITE = os.environ.get('SESSION_COOKIE_SAMESITE', 'Lax')  # 'Strict', 'Lax', or 'None'
...
LOGIN_REDIRECT_URL = '/admin/'  # O la ruta de tu dashboard
