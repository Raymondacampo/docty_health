...
from .views import CreateScheduleView, UpdateScheduleView, DeleteScheduleView, MySchedulesView, CreateWeekAvailabilityView, CreateWeekDayView, ClinicDetailView 
