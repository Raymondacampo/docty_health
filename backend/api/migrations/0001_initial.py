# Generated by Django 5.1.6 on 2025-03-19 17:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinics', models.ManyToManyField(related_name='doctors', to='api.clinic')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('specialties', models.ManyToManyField(related_name='doctors', to='api.specialty')),
            ],
        ),
    ]
