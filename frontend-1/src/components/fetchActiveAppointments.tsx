...
export const fetchActiveAppointments = async (): Promise<AppointmentsResponse> => {
  try {
    const response = await apiClient.get('appointments/appointments/?status=active');
    return response.data;
  } catch (error) {
...
export const fetchInactiveAppointments = async (): Promise<AppointmentsResponse> => {
  try {
    const response = await apiClient.get('appointments/appointments/?status=inactive');
    return response.data;
  } catch (error) {
