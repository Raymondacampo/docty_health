        ...
        <div className='hidden lg:flex items-center space-x-8 pb-2'>
          {isAuth ? (
                ...
                <div className='absolute right-0 mt-2 p-4 w-64 bg-white border border-gray-200 rounded-md shadow-lg z-50'>
                  {dropdownLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className='flex gap-1 items-center px-4 py-2.5 text-lg text-black hover:bg-gray-100'
            ...
            <div className='flex items-center gap-4'>
              <Link href='/signup' className='transition-colors bg-white text-black font-bold px-6 py-2.5 rounded-md'>
                Sign up
              </Link>
            ...
            {isAuth ? (
              <>
                <Link
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <HomeIcon className='inline-block mr-3' size={22} />
                  Home
                </Link>
                {dropdownLinks.map((link) => (
                  <Link
                ...
                >
                  <LogOut className='inline-block mr-3' size={22} />
                  Logout
                </button>
              </>
            ) : (
