  ...
  return (
    <div className="flex-col justify-center items-center gap-12 flex">
      <div className="w-full p-2.5 justify-start items-center gap-2.5 inline-flex border-b border-black/50 mt-16">
        <div className="text-center text-[#293241] tracking-wide text-2xl">
          Reviews
        </div>
      ...
      <div className="w-full px-2 flex-col justify-start items-start gap-10 flex">
        ...
        <div className="text-[#293241] tracking-wide flex flex-col gap-2 sm:text-sm xs:text-xs">
          Showing {reviewsToShow} of {totalReviews} reviews
          {canLoadMore && (
            <button
              onClick={loadMoreReviews}
              className="px-2.5 py-1 bg-[#ee6c4d] rounded-[5px] border border-[#ee6c4d] justify-center items-center gap-2.5 inline-flex text-center text-white tracking-wide sm:text-lg xs:text-md"
            >
              Load More
            </button>
          )}
