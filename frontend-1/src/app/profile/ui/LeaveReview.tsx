...
const LeaveAReview = ({ onReviewSubmitted }:{ onReviewSubmitted: () => void }) => {
...
//   };
  ...
  return (
      ...
      {!userReview && !showForm ? (
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#ee6c4d] rounded-[5px] border border-[#ee6c4d] text-white tracking-wide text-lg"
          >
            Leave a Review
          </button>
        </div>
    ...
    //             </svg>
    //           </div>
    //           <div className="text-black/50 tracking-wide text-xs">
    //             Your review
    //           </div>
    //         </div>
    //       </div>
    //       <div className="w-full break-words whitespace-pre-wrap text-[#293241] font-semibold tracking-wide break-all xs:text-base">
    //         {userReview.headline}
    //       </div>
    //       <div className="w-full break-words whitespace-pre-wrap text-[#3d5a80] tracking-wide text-sm break-all">
    //         {userReview.body}
    //       </div>
    //       <div className="justify-start items-center gap-2 inline-flex">
    //         <div className="text-center text-black/50 font-extralight tracking-wide text-xs">
    ...
    //         className="px-3 py-1.5 bg-[#ee6c4d] rounded-[5px] border border-[#ee6c4d] text-white tracking-wide text-base"
    //       >
    //         Edit Review
    //       </button>
    //     </div>
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-md flex justify-center items-center z-50">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full sm:min-w-[450px] sm:max-w-md bg-white sm:shadow-[0px_4px_4px_rgba(0,0,0,0.15)] sm:rounded-xl p-6 sm:p-8 flex flex-col gap-6 sm:gap-8 overflow-y-auto sm:h-auto h-full">
            ...
            <form onSubmit={() => console.log('submitted')} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  maxLength={100}
                  className="w-full px-3 py-2 border border-gray-300 rounded-[5px] text-[#3d5a80] text-base"
              ...
              <div className={`flex gap-4 justify-center sm:static bottom-2 left-1/2 transform -translate-x-1/2 w-full
                ...
                {isEditing && (
                  <button
                    ...
                    disabled={loading}
                    className={`px-3 py-1.5 bg-red-500 w-[45%] rounded-[5px] border border-red-500 text-white tracking-wide text-base ${
                      loading ? "opacity-50 cursor-not-allowed" : ""
                    }`}
                  >
