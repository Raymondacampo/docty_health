...
interface SpecialtySearchProps {
  onSpecialtyAdded: (response: { msg: string; status: string }) => void;
}

export default function SpecialtySearch({ onSpecialtyAdded }: SpecialtySearchProps) {
      ...
      {!isOpen ? (
        ...
        <div className="w-full flex-col gap-2">
          ...
          <button
            ...
            className="mt-2 text-white bg-[#293241] hover:bg-[#293241]/90 cursor-pointer text-sm font-normal font-['Inter'] px-2.5 py-2 rounded-md"
          >
            Cancel
          </button>
        </div>
