const UserInfo = () => {
    return (
        ...
        xs:flex-col xs:w-full">
            <div class="min-w-[150px] min-h-[150px] max-w-[150px] max-h-[150px] bg-[#d9d9d9] rounded-full"></div>
            <div class=" flex-col justify-start items-start gap-4 inline-flex">
                <div class="w-full  flex-col justify-start items-start flex">
                    <div class="w-full p-2.5 gap-2.5 inline-flex">
                        <div class="text-[#293241] font-['Inter'] tracking-wide
                        sm:text-xl 
                        xs:text-lg">Dr. Pepe Bolenos Asyinol</div>
                    </div>
                    <div class="w-full px-2.5 justify-start items-center gap-2.5 inline-flex">
                        <div class="text-[#293241] font-['Inter'] tracking-wide
                        sm:text-sm 
                        xs:text-xs">SPECIALTY</div>
                        <div class="text-[#293241] font-['Inter'] tracking-wide
                        sm:text-sm 
                        xs:text-xs">SPECIALTY</div>
                    </div>
                ...
                <div class="justify-start items-center gap-1.5 inline-flex">
                    ...
                    <div class=" text-[#3d5a80] font-['Inter'] tracking-wide text-wrap
                    sm:text-sm 
                    xs:text-xs">Santo Domingo oeste, calle cordillera septentrional 99.</div>
                </div>
            </div>
        </div>
    );
...
const ContactInfo = () => {
    return (
        <div class="w-auto justify-center items-center gap-[74px] flex">
            <div class="w-full px-8 py-4 bg-[#293241] rounded-[10px] flex-col justify-center items-start gap-4 inline-flex text-wrap break-all">
                <div class=" justify-start items-center gap-2.5 inline-flex">
                    <div class="text-white text-xl font-['Inter'] tracking-wide
                    sm:text-xl
                    xs:text-lg">Contact info</div>
                </div>
                <div class="justify-start items-center gap-2.5 inline-flex">
                    ...
                    <div class="h-5 text-white font-['Inter'] tracking-wide
                    sm:text-sm 
                    xs:text-xs">829-662-2197</div>
                </div>
                <div class="w-full justify-start items-center gap-2.5 inline-flex">
                    ...
                    sm:text-sm 
                    xs:text-xs">pepebolenosasynol@mail.com</div>
                </div>
...
const Description = () => {
    return (
        <div class=" p-2.5 justify-center items-center gap-2.5 inline-flex">
            <div class="grow shrink basis-0 text-[#293241] font-normal font-['Inter'] tracking-wide
            sm:text-base 
            xs:text-sm">
