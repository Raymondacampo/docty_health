        ...
        <div className="w-full py-12 px-4 bg-[#293241] justify-center items-center gap-[26px] inline-flex">
            ...
            <div className="w-auto py-px flex-col justify-center items-center gap-[55px] flex">
                ...
                <div className="w-auto flex-col justify-start items-center gap-[26px] inline-flex">
                    <div className="p-8 bg-white rounded-[15px] border border-black flex-col justify-start items-start gap-8 inline-flex">
                        <div className="text-center text-black text-base font-medium font-['Inter']">"As a doctor, Doctify has helped me connect with more patients and manage appointments efficiently."</div>
                        <div className="text-center text-black text-base font-extralight font-['Inter']">- Dr. Juan Ramirez</div>
                    </div>
