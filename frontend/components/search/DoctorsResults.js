...
const Filters = () => {
    ...
    <div className="w-full flex items-center justify-between">
        <div class=" justify-start items-center gap-[5px] inline-flex">
            <div class="h-auto text-black text-md font-medium font-['Inter'] tracking-wide sm:flex xs:hidden">Sort</div>
            <div class="p-1.5 px-3 rounded-[5px] border border-[#d9d9d9] justify-center items-center gap-1.5 flex">
                ...
                <div class="text-black text-xs font-['Inter'] tracking-wide">By relevance</div>
            </div>
        </div>
        <div class="px-3 py-1 bg-[#293241] rounded-[5px] border border-[#293241] flex-col justify-start items-start gap-2.5 inline-flex xl:hidden">
            <div class="self-stretch justify-start items-center gap-2 inline-flex">
                <div class="text-white text-sm font-normal font-['Inter'] tracking-wide">Filters</div>
...
const Doctor = () => {
    return(
        <div className="w-full ">
            <div class="w-auto px-2 pt-1 pb-2 rounded-lg border border-black/25 bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex-col justify-start items-center gap-4 flex 
            md:gap-2.5 md:min-w-2xl">
                <div class="self-stretch p-[5px] justify-start items-center gap-4 inline-flex relative
                sm:flex-row
                xs:flex-col">
                    <div class="w-[100px] h-[100px] bg-[#d9d9d9] rounded-full
                    xs:mt-8"></div>
                    <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                        <div class="self-stretch flex-col justify-start items-start gap-[3px] flex">
                            <div class="self-stretch py-[5px] border-b border-[#293241]/0 justify-between items-start inline-flex overflow-hidden
                            ">
                                <div class="text-[#293241] text-lg font-medium font-['Inter'] tracking-wide
                                sm:text-xl">Dr. Elver Penninson Gomez Bolanos</div>
                                <div class=" items-end gap-2 flex py-1
                                sm:relative
                                xs:absolute xs:top-0 xs:right-0">
                                    <div class="h-auto justify-center items-center gap-1 flex">
                                        ...
                                        <p class=" text-[#3d5a80] text-xs items-end font-light font-['Inter']">5</p>
                                    </div>
                                    <div class="h-[17px] justify-start items-center gap-2.5 flex">
                                        ...
                                        <div class="text-[#3d5a80] text-xs font-light font-['Inter'] tracking-wide whitespace-nowrap">10 reviews</div>
                                    </div>
                                </div>
                            </div>
                            <div class="self-stretch justify-start items-center gap-[9px] inline-flex">
                                <div class="text-[#293241] text-xs font-['Inter'] tracking-wide">CARDIOLOGO</div>
                                <div class="text-[#293241] text-xs font-['Inter'] tracking-wide">SPECIALTY</div>
                            </div>
                        </div>
                        <div class="self-stretch h-auto flex-col justify-start items-start gap-1 flex">
                            <div class="justify-center items-center gap-[9px] inline-flex">
                                ...
                                <div class="w-[97px] h-[18px] text-[#3d5a80] text-xs font-normal font-['Inter'] tracking-wide">Doctify dates</div>
                            </div>
                            <div class="justify-start items-center gap-2.5 inline-flex">
                                ...
                                <div class="w-[68px] h-[19px] text-[#3d5a80] text-xs font-normal font-['Inter'] tracking-wide">In person</div>
                            </div>
                            <div class="self-stretch justify-start items-center gap-3 inline-flex">
                                ...
                                <div class="grow shrink basis-0 text-[#3d5a80] text-xs font-normal font-['Inter'] tracking-wide">Santo Domingo oeste, calle cordillera septentrional 99.</div>
                            </div>
                        </div>
                    </div>
                </div>
                <button class="p-2 pl-3 pr-3 bg-[#ee6c4d] rounded-[10px] border border-[#ee6c4d] justify-center items-center gap-2.5 inline-flex
                sm:w-auto
                xs:w-full xs:max-w-sm">
                    <div class="text-white text-sm font-['Inter'] tracking-wide">View profile</div>
                </button>
            </div>
        </div>
