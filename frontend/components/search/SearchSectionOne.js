export default function SearchHead(){
    return(
        ...
        s:px-16 xs:px-2">
            ...
            xs:flex-col">
                <div className="w-full self-stretch p-2.5 bg-white rounded-[10px] border border-black justify-between items-center flex relative
                xl:max-w-sm lg:max-w-lg md:max-w-sm ">
                    <input placeholder='Cardiologist' className="text-black text-sm font-normal font-['Inter'] tracking-wide w-90%"></input>
                    <div className="absolute right-1 bg-transparent" data-svg-wrapper>
                ...
                md:w-auto">
                    <div className="w-auto h-auto text-white font-medium font-['Inter'] tracking-wide text-center
                    md:text-lg sm:text-md">Cardiologists in Santo Domingo</div>
                    <div className="w-auto text-white text-xs font-medium font-['Inter'] tracking-wide text-center
                    ">( 4 results )</div>
                </div>
            </div>
        </div>
