...
export default function TakesDatesFilter({ value, onChange }) {
  const [isDoctyChecked, setIsDoctyChecked] = useState(value === "true" || value === "virtual" || value === "in_person");
  ...
  return (
    <div className="text-black px-2">
      <div className="flex items-center gap-2 mb-2">
        <span className="text-md font-medium text-black">Docty appointments</span>
