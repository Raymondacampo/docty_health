    ...
    <div className="w-full relative bg-white overflow-hidden tracking-wide">
            ...
            <div className="relative z-10 flex items-center justify-center h-full text-white bg-black/50 px-4">
                <div>
                    ...
                    <div className="sitems-center justify-center text-xl">
                        Discover who we are and why we built Doctify
                    </div>             
                </div>
            </div>
        </section>
        <div class="w-full inline-flex justify-center items-center gap-16 my-16 flex-wrap">
            <div class="max-w-2xl p-4 inline-flex flex-col justify-start items-start gap-4">
                <div class="self-stretch justify-start ml-1 text-[#060648] text-2xl font-semibold font-['Inter'] tracking-wide">About Doctify</div>
                <div class="self-stretch justify-start text-black text-sm font-normal font-['Inter'] tracking-wide">
                    At Doctify, we believe that access to quality healthcare should be fast, simple, and stress-free. We are a Dominican startup born from a real need 
                    ...
                    of patients and the inefficiencies faced by doctors who want to serve better but lack digital visibility. That’s why we built Doctify — a smarter, more modern 
                    ...
                    or a smaller province, Doctify helps you find healthcare options near you — quickly and reliably. Doctors also benefit from a digital presence that allows them to manage 
                    their schedules, grow their practice, and serve more people with less hassle.
                    <br /><br />
                    Doctify is more than just a directory. It’s a movement toward accessible, transparent, and patient-centered healthcare in the Caribbean. We’re here to make sure no one is left 
            ...
            xs:p-4 xs:max-w-none xs:flex-wrap">
                <div className="flex flex-col gap-4 text-center">
                    ...
                    <div className="text-sm">
                        At Doctify, our mission is to make healthcare in the Dominican Republic more accessible, innovative, and efficient. We empower patients and doctors by providing a digital platform
