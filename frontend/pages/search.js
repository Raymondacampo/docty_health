...
export default function Search() {
    return (
        <>
            <SearchHead/>
            <div class="w-full h-[1075px] justify-center items-start gap-8 inline-flex">
                <SearchFilters/>
                <div class="w-auto flex-col justify-start items-start gap-4 inline-flex">
                    <div class="p-4 justify-start items-center gap-[5px] inline-flex">
                        <div class="w-[49px] h-[22px] text-black text-xl font-medium font-['Inter'] tracking-wide">Sort</div>
                        <div class="p-[5px] rounded-[5px] border border-[#d9d9d9] justify-center items-center gap-2.5 flex">
                            ...
                            <div class="w-[107px] h-[19px] text-black text-base font-light font-['Inter'] tracking-wide">By relevance</div>
                        </div>
                    </div>
                    <div class="h-[220px] px-3 py-4 bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex-col justify-start items-center gap-2.5 flex">
                        <div class="self-stretch p-[5px] justify-start items-center gap-4 inline-flex">
                            <div class="w-[100px] h-[100px] bg-[#d9d9d9] rounded-full"></div>
                            <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                                <div class="self-stretch h-[54px] flex-col justify-start items-start gap-[3px] flex">
                                    <div class="self-stretch py-[5px] border-b border-[#293241]/0 justify-between items-center inline-flex overflow-hidden">
                                        <div class="text-[#293241] text-xl font-bold font-['Inter'] tracking-wide">Dr. Elver Penninson Gomez</div>
                                        <div class="justify-center items-center gap-[13px] flex">
                                            <div class="h-[17px] justify-center items-center gap-1 flex">
                                                ...
                                                <div class="w-3 text-[#3d5a80] text-sm font-light font-['Inter'] tracking-wide">5</div>
                                            </div>
                                            <div class="h-[17px] justify-start items-center gap-2.5 flex">
                                                <div data-svg-wrapper>
                                ...
                                <div class="self-stretch h-16 flex-col justify-start items-start gap-[5px] flex">
                                    ...
                                    <div class="justify-start items-center gap-2.5 inline-flex">
                                        ...
                                        <path d="M10.8042 10H11.0555C11.5774 10.0002 12.0812 10.2005 12.4724 10.5635C12.8636 10.9264 13.1152 11.4269 13.1799 11.971L13.459 14.314C13.4841 14.5251 13.4662 14.7393 13.4064 14.9426C13.3467 15.1458 13.2465 15.3334 13.1125 15.4928C12.9785 15.6523 12.8137 15.78 12.6292 15.8674C12.4446 15.9549 12.2445 16 12.042 16H2.42799C2.22554 16 2.02538 15.9549 1.84082 15.8674C1.65626 15.78 1.49151 15.6523 1.3575 15.4928C1.22349 15.3334 1.1233 15.1458 1.06356 14.9426C1.00382 14.7393 0.985914 14.5251 1.01102 14.314L1.28942 11.971C1.35416 11.4267 1.60595 10.9259 1.99743 10.563C2.38891 10.2 2.89312 9.99979 3.41524 10H3.66579" stroke="#3D5A80" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        </div>
                                        <div class="w-[68px] h-[19px] text-[#3d5a80] text-sm font-normal font-['Inter'] tracking-wide">In person</div>
                                    </div>
                                    <div class="self-stretch justify-start items-center gap-3 inline-flex">
                                        ...
                                        <div class="grow shrink basis-0 text-[#3d5a80] text-sm font-normal font-['Inter'] tracking-wide">Santo Domingo oeste, calle cordillera septentrional 99.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="p-2.5 bg-[#ee6c4d] rounded-[10px] border border-[#ee6c4d] justify-center items-center gap-2.5 inline-flex">
                            <div class="text-white text-lg font-bold font-['Inter'] tracking-wide">View profile</div>
                        </div>
                    </div>
                    <div class="h-[220px] px-3 py-4 bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex-col justify-start items-center gap-2.5 flex">
                        <div class="self-stretch p-[5px] justify-start items-center gap-4 inline-flex">
                    ...
                    <div class="self-stretch py-4 justify-center items-center gap-4 inline-flex">
                        ...
                        <div class="w-[75px] h-[18px] text-[#ee6c4d] text-sm font-normal font-['Inter']">Page 1 of 7</div>
                        <div data-svg-wrapper>
                        <svg width="14" height="24" viewBox="0 0 14 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-56 h-[814px] bg-[#d9d9d9] justify-center items-center gap-2.5 flex">
                    <div class="w-[31px] h-[17px] text-black text-sm font-normal font-['Inter'] tracking-wide">ADS<br/></div>
                </div>
            </div>
        </>
    );
