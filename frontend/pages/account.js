      ...
      {user &&  
        <div className="flex-col justify-center items-center gap-11 flex sm:w-auto xs:w-full">
          <div className="w-full flex-col justify-center items-start gap-2 flex order-first">
            ...
            {user.is_doctor ? (
              <div className="text-[#293241] text-xl font-normal font-['Inter']">Hello Dr. {user.email}</div>
            ) : (
              <div className="text-[#293241] text-xl font-normal font-['Inter']">Hello {user.email}</div>
            )}
          </div>
